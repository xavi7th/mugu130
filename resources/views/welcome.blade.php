...
@section('contents') @if (Agent::isMobile() && Agent::isOpera())
<section id="mid">
		...
		<div class="grid-40 push-10">
			<div id="form" class="ui segments">
				...
				<div class="ui segment" style="padding: 0px 1em;">
					...
					<div class="ui tab {{ (Route::currentRouteName() == 'register' || Route::currentRouteName() == 'referral') && Agent::isDesktop() ? 'active' : null }}"
					...
					<div class="ui tab {{ (Route::currentRouteName() == 'login' ? 'active' : null || Route::currentRouteName() == 'home') && Agent::isDesktop() ? 'active' : null }}"
					 data-tab="login">
