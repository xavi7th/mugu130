...
<meta name="description" content="Know the various cash prizes you can win on {{ env('APP_NAME') }}"/>
<meta name="author" content="{{ env('APP_AUTHOR') }}">
<meta name="abstract" content="Know the various cash prizes you can win on {{ env('APP_NAME') }}"/>
