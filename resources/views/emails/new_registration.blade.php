													...
													<tr>
														<td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
															...
															<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
																<tbody>
																	<tr>
																		<td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;font-family: &quot;Comic Sans MS&quot;, &quot;Marker Felt-Thin&quot;, Arial, sans-serif;">
																			<h1><a href="http://bitensured.com" target="_blank"><span style="color:#F0FFF0">BITENSURED</span></a></h1>
																		</td>
																	</tr>
																</tbody>
															</table>
																...
																<tbody>
																	<tr>
																		<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																			...
																			<p>You just created an account on Bitensured.com</p>
																			<p>Bla bla bla...</p>
																		</td>
																	</tr>
																</tbody>
																...
																<tbody>
																	<tr>
																		<td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
																			<a class="mcnButton " title="Login" href="http://bitensured.com" target="_blank" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Login</a>
																		</td>
																	</tr>
																</tbody>
															</table>
