																								...
																								<tr>
																									<td valign="top" class="mcnTextContent"
																										...
																										<ul class="mcnTextContent"
																											...
																											<li>Amount: <strong
																													style="color:{{ $amt < 0 ? 'red' : 'green' }}">
																													₦{{ number_format($amt, 2) }}</strong></li>
																											<li>Transaction Charges: <strong> ₦0 (will be determined by your
																													bank)</strong></li>
																											...
																											<li>New balance: <strong
																													style="color:{{ $user_balance < 0 ? 'red' : 'green' }}">
																				...
																				<tr>
																					<td
																						...
																						<table border="0" cellpadding="0" cellspacing="0"
																							...
																							style="border-collapse: separate !important;border-radius: 3px;background-color: #0E91CE;">
																							<tbody>
																								<tr>
																									{{-- <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
																										<a class="mcnButton " title="Login" href="{{ route('password.request') }}" target="_blank"
																									style="font-weight: bold;letter-spacing: normal;line-height:
																									100%;text-align: center;text-decoration: none;color: #FFFFFF;">Not
																									Me</a>
																					</td> --}}
																				</tr>
																			</tbody>
