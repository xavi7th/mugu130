...
angular.module('customTableRow', []).directive('customTableRow', ['$localStorage', 'sendRequest', function ($localStorage, sendRequest) {
  return {
    restrict: 'E',
    scope:{
      dest : '=',
    ...
    templateUrl:'angular/directive-templates/customTableRowTemplate.php',
    replace: true,
